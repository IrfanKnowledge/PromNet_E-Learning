            ...
            <nav class="sidebar-nav left-sidebar-menu-pro">
                <?php if ($this->session->userdata('user') == 'admin'): ?>
                  <ul class="metismenu" id="menu1">
                      ...
                      <li>
                          <a class="has-arrow" href="all-professors.html" aria-expanded="false"><span class="educate-icon educate-data-table icon-wrap"></span> <span class="mini-click-non">Nilai Siswa</span></a>
