    ...
    <div class="container-fluid">
        <div class="row">
          ...
          <table class="table table-bordered table-hover" align ="center">
              ...
              <tbody>
                <form id="form_tes" action="<?php echo site_url('Tes_Pengayaan_Jawaban_Siswa/tes');?>" method="post">

                  <!-- jika data Soal Tidak ada, maka setting jumlah soal = 0 -->
                  <?php if (empty($tes_pengayaan_soal)): ?>
                  ...
                  <?php  $no = 1; foreach ($tes_pengayaan_soal as $column) { ?>
                    <tr class="table-primary">
                      ...
                      <div id="jumlah_soal" jumlah_soal="<?php echo count($tes_pengayaan_soal); ?>"></div>
  ...
  <script type="text/javascript">
    $(window).load(function () {
      ...
      if (jumlah_soal != 0) {
        ...
        $.ajax({
          url:"http://localhost/PromNet_E-Learning/index.php/Tes_Pengayaan_Jawaban_Siswa/Ambil_Jawaban",
          method:"post",
      ...
      var auto_update = setInterval(function () {
        ...
        $.ajax({
          url:"http://localhost/PromNet_E-Learning/index.php/Tes_Pengayaan_Jawaban_Siswa/Ubah_Jawaban",
          method:"post",
      ...
      $('#konfirmasi_ok').click(function () {
        ...
        //mengambil id_tes pada tes_pengayaan saat ini
        var id_tes = $("#id_tes").attr("id_tes");
        //mengambil kd_mapel yang terdapat pada URL halaman ini
        var kd_mapel = $('#selesai').attr("name");
        $.ajax({
          url: "http://localhost/PromNet_E-Learning/index.php/Tes_Pengayaan_Jawaban_Siswa/Submit",
          method: "post",
      ...
      // console.log(id_tes);
      // mengambil id_tes pada tes_pengayaan ini
      var id_tes = $("#id_tes").attr("id_tes");
      $.ajax({
        url: "http://localhost/PromNet_E-Learning/index.php/Tes_Pengayaan_Waktu_Siswa/Waktu_Mulai_Dan_Durasi_Soal",
        method: "post",
        data: {id_tes:id_tes},
        success: function (data) {
