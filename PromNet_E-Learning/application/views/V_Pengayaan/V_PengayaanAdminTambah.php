                      ...
                      <div class="navbar">
                          <div class="subnav">
                            ...
                            <div class="subnav-content">
                                <a title="Add Pengayaan" href="<?php echo site_url('C_PengayaanAdmin/V_PengayaanAdminTambah/'); ?>" class=" <?php if ($this->uri->segment(2) == 'V_PengayaanAdminTambah'){ ?> text-white bg-primary <?php } ?>"><span class="mini-sub-pro">Tambah Pengayaan</span></a>
                            </div>
                          </div> 
                        </div>
                        ...
                        <!-- Edit Modal HTML -->
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <form action="<?php echo site_url('C_PengayaanAdmin/PengayaanAdminTambah');?>" method="POST">
                                  ...
                                  <div class="modal-header">
                                      <h4 class="modal-title">Tambah Tes Pengayaan</h4>
                                        ...
                                        <?php } ?>
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><a href="<?php echo site_url('C_PengayaanAdmin/V_PengayaanAdminTambah') ?>">&times;</a></button>
                                  </div>
                                ...
                                <div class="modal-footer">
                                  <a href="<?php echo site_url('C_PengayaanAdmin/V_PengayaanAdminTambah') ?>"><input type="button" class="btn btn-default" data-dismiss="modal" value="Batal"></a>
