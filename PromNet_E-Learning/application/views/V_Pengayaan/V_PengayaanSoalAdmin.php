            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      ...
                      <div class="navbar">
                          <div class="subnav">
                            <button class="subnavbtn">Soal Pengayaan  <i class="fa fa-caret-down"></i></button>
                            <div class="subnav-content">
                                <a title="Add Sesi" href="<?php echo site_url('C_PengayaanSoalAdmin2/V_PengayaanSoalAdminTambah/'); ?>" class=" <?php if ($this->uri->segment(2) == 'V_PengayaanSoalAdminTambah'){ ?> text-white bg-primary <?php } ?>"><span class="mini-sub-pro">Tambah Soal Pengayaan</span></a>
                            </div>
                          </div> 
                        </div>
  ...
  <div id="editdata" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="<?php echo site_url('C_PengayaanSoalAdmin2/PengayaanSoalAdminEdit'); ?>" method="post">
        <!--<form id="form" enctype="multipart/form-data">-->
        <!--<form>-->
          <div class="modal-header">
            <h4 class="modal-title">Edit Soal Pengayaan</h4>
  ...
  <div id="deletedata" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="<?php echo site_url('C_PengayaanSoalAdmin2/PengayaanSoalAdminDelete'); ?>" method="post">
        <!--<form id="form" enctype="multipart/form-data">-->
        <!--<form>-->
          <div class="modal-header">
