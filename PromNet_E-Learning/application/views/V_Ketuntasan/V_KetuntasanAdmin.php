                      ...
                      <div class="navbar">
                          <div class="subnav">
                            ...
                            <div class="subnav-content">
                                <a title="Add Sesi" href="<?php echo site_url('C_KetuntasanAdmin/V_KetuntasanAdminTambah/'); ?>" class=" <?php if ($this->uri->segment(2) == 'V_KetuntasanAdminTambah'){ ?> text-white bg-primary <?php } ?>"><span class="mini-sub-pro">Tambah tes Ketuntasan</span></a>
                            </div>
                          </div>
                        </div>
  ...
  <div id="editdata" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="<?php echo site_url('C_KetuntasanAdmin/KetuntasanAdminEdit'); ?>" method="post">
        <!--<form id="form" enctype="multipart/form-data">-->
        <!--<form>-->
          <div class="modal-header">
            <h4 class="modal-title">Edit Tes Ketuntasan</h4>
  ...
  <div id="deletedata" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="<?php echo site_url('Ketuntasan_Admin/KetuntasanAdminDelete'); ?>" method="post">
        <!--<form id="form" enctype="multipart/form-data">-->
        <!--<form>-->
          <div class="modal-header">
