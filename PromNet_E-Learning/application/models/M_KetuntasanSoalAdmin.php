...
class M_KetuntasanSoalAdmin extends CI_Model {
...
// ================================================
  ...
  {
    $this->db->insert('tes_ketuntasan_soal', $data);
  ...
  public function update($id= -1, $data = array())
{
    $this->db->set($data);
    $this->db->where('id',$id);
    $this->db->update('tes_ketuntasan_soal');
  ...
  {
    $this->db->where('id',$id);
    $this->db->delete('tes_ketuntasan_soal');
